...
//     Sort sortByName = Sort.by("name"); //¿lo ordenamos por nombre o por apellidos?
...
@GetMapping("/{id}")
public ResponseEntity<Map<String, Object>> findAsistenteById(@PathVariable(name = "id", required = true) 
                            Integer idAsistente){
        ...
        try {
            ...
            String errorMessage = "Erreur grave, et la causa la plus probable de l'erreur est: " + e.getMostSpecificCause();
